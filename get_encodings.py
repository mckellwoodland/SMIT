...
from trainer import get_all_image_tokens
...
parser.add_argument('--json_list', default='/Morfeus/Nihil/SMIT/dataset/dataset_0.json', type=str, help='dataset json file')
...
def main_worker(gpu, args):
    ...
    get_all_image_tokens(model_inferer,val_loader=loader,args=args)
